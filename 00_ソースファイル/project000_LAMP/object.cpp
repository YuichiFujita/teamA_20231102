...
//	テクスチャの分割数Xの設定処理
//============================================================
void CObject::SetTexturePatternX(const D3DXVECTOR2& /*rTexPart*/)
{
	// 例外処理
	assert(false);
}
...
//	テクスチャ分割数X取得処理
//============================================================
D3DXVECTOR2 CObject::GetTexturePatternX(void) const
{
	// 例外処理
	assert(false);
...
//	テクスチャの分割数Yの設定処理
//============================================================
void CObject::SetTexturePatternY(const D3DXVECTOR2& /*rTexPart*/)
{
	// 例外処理
	assert(false);
}
...
//	テクスチャ分割数Y取得処理
//============================================================
D3DXVECTOR2 CObject::GetTexturePatternY(void) const
{
	// 例外処理
	assert(false);
...
//	テクスチャの分割数Zの設定処理
//============================================================
void CObject::SetTexturePatternZ(const D3DXVECTOR2& /*rTexPart*/)
{
	// 例外処理
	assert(false);
}
...
//	テクスチャ分割数Z取得処理
//============================================================
D3DXVECTOR2 CObject::GetTexturePatternZ(void) const
{
	// 例外処理
	assert(false);
